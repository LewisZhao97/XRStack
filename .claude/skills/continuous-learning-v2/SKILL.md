...
**v2.1** adds **project-scoped instincts** — Unity XR patterns stay in your XR project, SDK conventions stay in your SDK project, and universal patterns (like "always validate input") are shared globally.
...
```json
{
  "hooks": {
    ...
    "PostToolUse": [{
      ...
      "hooks": [{
        "type": "command",
        "command": "bash .claude/skills/continuous-learning-v2/hooks/observe.sh post"
      }]
    }]
  }
}
...
|-------------|-------|---------|
| Unity/XR conventions | **project** | "Use m_ prefix for private fields", "Pool XR interactables" |
| File structure preferences | **project** | "Tests in Tests/", "Scripts in Assets/Scripts/" |
| Code style | **project** | "Allman braces", "SerializeField over public" |
| Error handling strategies | **project** | "Debug.LogException for caught errors" |
| Security practices | **global** | "Validate user input", "No hardcoded secrets" |
